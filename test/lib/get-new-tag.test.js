...
describe('getNewTag',  () => {
  ...
  test('should bump a minor release',  () => {
    expect(getNewTag('1', 'minor')).toEqual('1.1.0');
    expect(getNewTag('1.2', 'minor')).toEqual('1.3.0');
    expect(getNewTag('1.2.3', 'minor')).toEqual('1.3.0');
  });

  test('should bump a major release',  () => {
    expect(getNewTag('1', 'major')).toEqual('2.0.0');
    expect(getNewTag('1.2', 'major')).toEqual('2.0.0');
    expect(getNewTag('1.2.3', 'major')).toEqual('2.0.0');
  });
